...
@Component({
  selector: 'app-indicator-selection',
  templateUrl: './indicator-selection.component.html',
  styleUrls: ['./indicator-selection.component.scss']
})
export class IndicatorSelectionComponent implements OnInit {
