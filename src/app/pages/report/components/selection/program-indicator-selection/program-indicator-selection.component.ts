...
@Component({
  selector: 'app-program-indicator-selection',
  templateUrl: './program-indicator-selection.component.html',
  styleUrls: ['./program-indicator-selection.component.scss']
})
export class ProgramIndicatorSelectionComponent implements OnInit {
